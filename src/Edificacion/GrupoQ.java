...
public class GrupoQ implements Edificacion  {
    ...
    public void crear(int idjugador) {
        ...
        if (idjugador==1){
            listaEdificacion.Agregar("GrupoQ", raza.vida(2000), 0 , idjugador);
        }else{
            listaEdificacion2.Agregar("GrupoQ", raza.vida(2000), 0 , idjugador);
        }
        
        factory = FactoryProducer.getFactory(5);
        Vehiculo vehiculo = factory.getVehiculo((2));
