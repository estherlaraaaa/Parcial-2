...
public class RecolectarR2 implements Edificacion {
    ...
    public void crear(int idjugador) {
        ...
        if (idjugador==1){
            listaEdificacion.Agregar("Recolectador de recursos 2", raza.vida(4000), raza.fase(1), idjugador); 
        }else{
            listaEdificacion2.Agregar("Recolectador de recursos 2", raza.vida(4000), raza.fase(1), idjugador); 
        }
