...
public class Especialistas implements Milicia {
    ...
    public void crear(int idjugador) {
        ...
        if (idjugador == 1) {
            listaMilicia.Agregar("Especialista", raza.vida(3000), raza.fase(1), idjugador, raza.ataque(1000), 0);
        } else {
            listaMilicia2.Agregar("Especialista", raza.vida(3000), raza.fase(1), idjugador, raza.ataque(1000), 0);
        }
